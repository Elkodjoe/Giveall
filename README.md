...
- `app/` — Expo Router screens: Onboarding Screens 1–6, plus `checkin.tsx` (daily 90-second check-in), `bids.tsx` (Bid Tracker), `curiosity.tsx` (Curiosity Card), `memory-vault.tsx`, `settings.tsx`, and `partner.tsx` (double opt-in Partner Mode).
